...
internal sealed class EntregarPedidoCommandHandler(
    IPedidoRepository pedidos,
    ITenantContext tenant,
    TimeProvider relogio) : ICommandHandler<EntregarPedidoCommand>
{
    public async Task<Result> Handle(EntregarPedidoCommand command, CancellationToken cancellationToken)
    {
        ...
        return pedido.Entregar(relogio.GetUtcNow());
    }
}
