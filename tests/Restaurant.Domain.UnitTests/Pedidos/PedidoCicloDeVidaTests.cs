...
public sealed class PedidoCicloDeVidaTests
{
    ...
    public void Abrir_levanta_PedidoAbertoDomainEvent()
    {
        var pedido = Pedido.Abrir(
            Restaurant.Domain.Compartilhado.EstabelecimentoId.Novo(),
            Restaurant.Domain.Compartilhado.MesaId.Novo(),
            Restaurant.Domain.Compartilhado.FuncionarioId.Novo(),
            NumeroPedido.Criar(new DateOnly(2026, 7, 25), 7).Value,
            nomeCliente: null,
            observacao: null,
            Restaurant.Domain.Compartilhado.Percentual.Zero(),
            Agora).Value;
